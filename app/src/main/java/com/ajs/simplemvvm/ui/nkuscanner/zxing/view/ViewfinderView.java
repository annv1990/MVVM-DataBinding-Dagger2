...
package com.ajs.simplemvvm.ui.nkuscanner.zxing.view;
...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        frameColor = resources.getColor(R.color.transparent);
        laserColor = resources.getColor(R.color.colorPrimary);
        resultPointColor = resources.getColor(R.color.transparent);
//        frameColor = resources.getColor(R.color.blue);
//        laserColor = resources.getColor(R.color.red);
//        resultPointColor = resources.getColor(R.color.possible_result_points);
    ...
    public void onDraw(Canvas canvas) {
        ...
        //The error was prompted, so the following code was changed
        ...
        if (resultBitmap != null) {
            ...
            canvas.drawRect((0 - linewidht) + frame.right, -49 + frame.bottom, 1 + frame.right, 1 + frame.bottom, paint);
