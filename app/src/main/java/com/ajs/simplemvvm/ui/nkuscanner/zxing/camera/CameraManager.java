...
package com.ajs.simplemvvm.ui.nkuscanner.zxing.camera;
...
public final class CameraManager {
    ...
    private static final int MIN_FRAME_HEIGHT = 680;
    ...
    public void requestAutoFocus(Handler handler, int message) {
        if (camera != null && previewing) {
            ...
            //Log.d(TAG, "Requesting auto-focus autoCertificateCallBack");
